           ...
           <div class="btn-toolbar justify-content-between mb-3">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtJobTitle" runat="server" CssClass="form-control" placeholder="Ex.Web Develper,App Developer"
                        required>

                    </asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
                    <label for="txtNoOfPost" style="font-weight: 600">No Of Post</label>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtQualification" runat="server" CssClass="form-control" placeholder="Ex.MCA, BTech, MBA, BSC.IT, BSC.Sc, BE" required>

                    </asp:TextBox>
                </div>
                <div class="col-md-6 pt-3">
                    <label for="txtExperience" style="font-weight: 600">Experience</label>
                    <asp:TextBox ID="txtExperience" runat="server" CssClass="form-control" placeholder="Ex. 2 years, 1.5 years, Freshers"
                        required>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:TextBox ID="txtSalary" runat="server" CssClass="form-control" placeholder="Ex.25000/month, 7L/Tear"
                        required>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    <label for="txtCompany" style="font-weight: 600">Collage/Company Name</label>
                ...
                <div class="col-md-6 pt-3">
                    <label for="ddlJobType" style="font-weight: 600">Collage/Company Logo</label>
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Country is required" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" Font-Size="Small" InitialValue="0" ControlToValidate="ddlCountry">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3 pt-4" >
                <div class="col-md-3 col-md-offset-2 mb-3">
                    <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary btn-block" BackColor="#7200cf" 
                        Text="Add Job" OnClick="btnAdd_Click"/>
