             ...
             <div class="row mb-3 pt-sm-3">
                <div class="col-md-12">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered"
                        EmptyDataText="No Record Display..!" AutoGenerateColumns="False" AllowPaging="True" PageSize="5"
                ...
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# DataBinder.Eval(Container,"DataItem.Resume","../{0}") %>' >
                                    ...
                                    <asp:Image ID="Img" runat="server" ImageUrl="~/Images/Downicon.jpg"  Width="25px"/>
                            ...
                            <asp:CommandField CausesValidation="false"  HeaderText="Delete" ShowDeleteButton="true"
                                DeleteImageUrl="~/Images/Cross.jpg" ButtonType="Image">
